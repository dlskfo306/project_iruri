	...
	<div class="iruri__wrapper">
		...
		<main>
				...
				<article class="c_detail_main">
					...
					<div class="c_detail_start">
						...
						<div class="c_detail_img">
							<img
								src="${CONTEXT_PATH}/iruri/display?fileName=${challengeInfo.classImage}"
								alt="">
						</div>
						...
						<div class="c_detail_info1">
							...
							<div class="c_detail_goal">${challengeInfo.classGoal}</div>
						</div>
						...
						<div class="c_detail_info2">
							...
							<div class="info_ul">
								<ul>
									...
									<li class="c_mini_info2">주
										${challengeInfo.classExerciseCount}일</li>
									<li class="c_mini_info2">${challengeInfo.classJoinMember}
										/ ${challengeInfo.classTotalMember}</li>
			...
			<div class="c_detail_maininfo" id="info">
				<div class="c_main_info">${challengeInfo.classContent}</div>
			</div>
			...
			<div class="page_nation_certify"></div>
				...
				<div class="c_certify_modal_start">
					...
					<form class="c_certify_modal_form">
						...
						<div class="c_certify_content">
							<p>내용</p>
							<textarea cols="30" rows="50" name="boardContent"
								class="inputbox_certify2" required="required"></textarea>
						</div>

						<div class="c_certify_img_button">
							<p>사진첨부</p>
							<input type="file" name="uploadFile" accept=".jpg, .png"
								id="certify_upload"><label for="certify_upload"
								class="certify_file_upload" required="required"></label> <span
								style="color: #999;">* 최대 5MB 크기의 jpg.png</span>
			...
			<div id="c_certify_modify_modal">
				...
				<div class="c_certify_modal_start">
					...
					<form class="c_certify_modal_form">
						...
						<div class="c_certify_name">
							<p>제목</p>
							<input type="text" name="boardTitle1" class="inputbox_cetify1"
								required="required">
						</div>

						<div class="c_certify_content">
							<p>내용</p>
							<textarea cols="30" rows="50" name="boardContent1"
								class="inputbox_certify2" required="required"></textarea>
						</div>
						...
						<div class="modal_button">
							<button class="c_certify_modify_submit" type="submit">인증글
								수정하기</button>
						</div>
					</form>
				</div>
				...
				<form:form name="commentForm" class="c_reply_insertBox" method="Post"
					...
					<table>
						<tr>
							...
							<td class="c_reply_textarea"><textarea class="boardContent"
									placeholder="글을 작성하세요." name="boardContent"></textarea></td>
							<c:url value="/iruri/c_detail_reply_insert"
								var="challengeReplyInsert" />
				...
				<div class="c_complain_modal_start">
					...
					<form class="c_complain_form">
						...
						<ul class="c_complain_modal_ul">
							<li><input type="radio" name="reportContent" id="complain1"
								value="욕설, 비방, 차별, 혐오"><label for="complain1"
								class="c_complain_modal_label" onclick="radio_click(this)">
									욕설, 비방, 차별, 혐오 </label></li>
		
							<li><input type="radio" name="reportContent" id="complain2"
								value="홍보, 영리목적"><label for="complain2"
								class="c_complain_modal_label" onclick="radio_click(this)">
									홍보, 영리목적 </label></li>
		
							<li><input type="radio" name="reportContent" id="complain3"
								value="음란, 청소년 유해"><label for="complain3"
								class="c_complain_modal_label" onclick="radio_click(this)">
									음란, 청소년 유해 </label></li>
		
							<li><input type="radio" name="reportContent" id="complain4"
								value="도배, 스팸"><label for="complain4"
								class="c_complain_modal_label" onclick="radio_click(this)">
									도배, 스팸 </label></li>
						</ul>
				...
				<div class="reply_modify_modal_start">
					...
					<form class="reply_form">
						...
						<div class="reply_modify_content">
							<textarea cols="30" rows="50" class="inputbox_certify2"
								name="reply_modify_content"></textarea>
						</div>
