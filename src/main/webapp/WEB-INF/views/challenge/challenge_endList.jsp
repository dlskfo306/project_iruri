...
<c:set var="CONTEXT_PATH_CHALLENGE"
	value="${pageContext.request.contextPath}/iruri" scope="application" />
<!DOCTYPE html>
<html lang="ko">
		...
		<main>
			...
			<div class="c_main_tab">
				<p class="c_like_last">
					...
					<input type="radio" id="c_tap1" name="c_taps"
						onclick="location.href='/ex/iruri/challengeList'"> <label
						for="c_tap1">전체챌린지</label> <input type="radio" id="c_tap2"
						name="c_taps"
						onclick="location.href='/ex/iruri/challengeLikeList'"> <label
						for="c_tap2">관심챌린지</label> <input type="radio" id="c_tap3"
						name="c_taps" onclick="location.href='/ex/iruri/challengeEndList'"
						checked> <label for="c_tap3">지난챌린지</label>
				</p>
			...
			<div class="c_search">
				...
				<form class="c_search_box" method="GET"
					action="/ajax/challengeEndList">
						...
						<ul class="c_make_modal_ul">
							<div class="input_check">
								<input type="checkbox" name="agree" id="check1" value="check1"
									required><label for="check1" class="c_make_modal_label">
							...
							<div class="input_check">
								<input type="checkbox" name="agree" id="check2" value="check2"
									required><label for="check2" class="c_make_modal_label">
							...
							<div class="input_check">
								<input type="checkbox" name="agree" id="check3" value="check3"
									required><label for="check3" class="c_make_modal_label">
				...
				function getlist(page) {
					...
					$.ajax({
								...
								success : function(result) {
									console.log(result);
									var sortText = document
											.querySelector('#select').innerText;
									...
									if (list.length < 1) {
										...
										$(list).each(function() {
											...
											htmls += '<img src="${CONTEXT_PATH}/iruri/display?fileName='
													+ this.classImage
													+ '" alt="">';
											htmls += '</div>';

											htmls += '<div class="c_list_title">';
											htmls += '<a href="challenge_detail_before?classId='
													+ this.classId
													+ '"target="_blank">';
