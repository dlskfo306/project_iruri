...
하트 클릭 시
* 로그인 한 유저는 **하트를 클릭 시 관심챌린지로 등록**이 됩니다.
...
* 총 모집 인원은 직접 입력할 수 있는 칸과 '인원제한없음'을 선택할 수 있는데, **'인원제한없음'을 클릭 시에는 기입할 수 있는 칸은 비활성화**가 됩니다.
* 사진 파일을 올리지 않을 경우 **디폴트 이미지 파일로 등록**이 됩니다.
...
* 인증글 리스트에선 **내 인증글 클릭 시 수정, 삭제가 가능**하고, **다른 회원의 인증글은 확인만 가능**합니다.
